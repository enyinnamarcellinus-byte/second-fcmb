    ...
    function T(e, o) {
        function t(r, n, u) {
            if (!(typeof document > "u")) {
                u = B({}, o, u), typeof u.expires == "number" && (u.expires = new Date(Date.now() + u.expires * 864e5)), u.expires && (u.expires = u.expires.toUTCString()), r = encodeURIComponent(r).replace(/%(2[346B]|5E|60|7C)/g, decodeURIComponent).replace(/[()]/g, escape);
                var i = "";
                for (var b in u) u[b] && (i += "; " + b, u[b] !== !0 && (i += "=" + u[b].split(";")[0]));
...
`,
        ne = () => {
            ...
            e.innerHTML = `${oe}`, e.id = "cw-widget-styles", e.dataset.turboPermanent = !0, document.body.appendChild(e)
        },
        M = (e, o) => {
        ...
        F = e => {
            M("cw-bubble-holder", e), M("cw-widget-holder", e), M("cw-widget-styles", e)
        },
        y = (e, o) => {
        ...
        ie = () => {
            ...
            new MutationObserver(n => {
                n.forEach(() => {
                    e !== document.location.href && (e = document.location.href, N({
                        referrerURL: e,
                        referrerHost: o
                    }))
                })
        ...
        we = ({
            ...
            return typeof window.CustomEvent == "function" ? t = new CustomEvent(e, {
                detail: o
            }) : (t = document.createEvent("CustomEvent"), t.initCustomEvent(e, !1, !1, o)), t
        },
        E = ({
            eventName: e,
            data: o
    ...
    const ge = e => {
        ...
        be = ({
            ...
            r.setAttributeNS(null, "id", "woot-widget-bubble-icon"), r.setAttributeNS(null, "width", "24"), r.setAttributeNS(null, "height", "24"), r.setAttributeNS(null, "viewBox", "0 0 240 240"), r.setAttributeNS(null, "fill", "none"), r.setAttribute("xmlns", "http://www.w3.org/2000/svg");
            const n = document.createElementNS("http://www.w3.org/2000/svg", "path");
            if (n.setAttributeNS(null, "d", o), n.setAttributeNS(null, "fill", "#FFFFFF"), r.appendChild(n), t.appendChild(r), P(window.$chatwoot.type)) {
                const u = document.createElement("div");
                u.id = "woot-widget--expanded__text", u.innerText = "", t.appendChild(u), c += " woot-widget--expanded"
            }
            return t.className = c, t.title = "Open chat window", t
        },
        he = e => {
            e && y(C, "woot-hidden"), y(C, "woot--bubble-holder"), C.id = "cw-bubble-holder", C.dataset.turboPermanent = !0, V.appendChild(C)
        },
        pe = e => {
            g.events.onBubbleToggle(e), e ? E({
                eventName: de
            }) : (E({
                eventName: ce
            }), U.focus())
        ...
        S = (e = {}) => {
            ...
            window.$chatwoot.isOpen = c, k(U, "woot--hide"), k($, "woot--hide"), k(v, "woot--hide"), pe(c)
        },
        fe = () => {
    ...
    (function() {
        var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/",
            o = {
                ...
                endian: function(t) {
                    if (t.constructor == Number) return o.rotl(t, 8) & 16711935 | o.rotl(t, 24) & 4278255360;
                    for (var c = 0; c < t.length; c++) t[c] = o.endian(t[c]);
                    return t
                },
                ...
                bytesToWords: function(t) {
                    for (var c = [], r = 0, n = 0; r < t.length; r++, n += 8) c[n >>> 5] |= t[r] << 24 - n % 32;
                    return c
                },
                wordsToBytes: function(t) {
                    for (var c = [], r = 0; r < t.length * 32; r += 8) c.push(t[r >>> 5] >>> 24 - r % 32 & 255);
                    return c
                },
                bytesToHex: function(t) {
                    for (var c = [], r = 0; r < t.length; r++) c.push((t[r] >>> 4).toString(16)), c.push((t[r] & 15).toString(16));
                    return c.join("")
                },
                hexToBytes: function(t) {
                    for (var c = [], r = 0; r < t.length; r += 2) c.push(parseInt(t.substr(r, 2), 16));
                    return c
                },
                bytesToBase64: function(t) {
                    for (var c = [], r = 0; r < t.length; r += 3)
                        for (var n = t[r] << 16 | t[r + 1] << 8 | t[r + 2], u = 0; u < 4; u++) r * 8 + u * 6 <= t.length * 8 ? c.push(e.charAt(n >>> 6 * (3 - u) & 63)) : c.push("=");
                    return c.join("")
                },
                base64ToBytes: function(t) {
                    t = t.replace(/[^A-Z0-9+\/]/ig, "");
                    for (var c = [], r = 0, n = 0; r < t.length; n = ++r % 4) n != 0 && c.push((e.indexOf(t.charAt(r - 1)) & Math.pow(2, -2 * n + 8) - 1) << n * 2 | e.indexOf(t.charAt(r)) >>> 6 - n * 2);
                    return c
                }
            };
        X.exports = o
    ...
    var Ce = X.exports,
        D = {
            ...
            bin: {
                stringToBytes: function(e) {
                    for (var o = [], t = 0; t < e.length; t++) o.push(e.charCodeAt(t) & 255);
                    return o
                },
                bytesToString: function(e) {
                    for (var o = [], t = 0; t < e.length; t++) o.push(String.fromCharCode(e[t]));
                    return o.join("")
                }
            }
        },
    ...
    function Se(e) {
        ...
        var e = Ce,
            ...
            r = function(n, u) {
                ...
                for (var i = e.bytesToWords(n), b = n.length * 8, s = 1732584193, a = -271733879, d = -1732584194, l = 271733878, w = 0; w < i.length; w++) i[w] = (i[w] << 8 | i[w] >>> 24) & 16711935 | (i[w] << 24 | i[w] >>> 8) & 4278255360;
        ...
        r._ff = function(n, u, i, b, s, a, d) {
            ...
            var l = n + (i ^ (u | ~b)) + (s >>> 0) + d;
            return (l << a | l >>> 32 - a) + u
        }, r._blocksize = 16, r._digestsize = 16, K.exports = function(n, u) {
            if (n == null) throw new Error("Illegal argument " + n);
    ...
    const _e = ye(Be),
        ...
        Te = ({
            identifier: e = "",
            user: o
        }) => `${$e.reduce((c,r)=>`${c}${r}${o[r]||""}`,"")}identifier${e}`,
        Me = (...e) => _e(Te(...e)),
        ...
        O = (e, o, {
            ...
            typeof o == "object" && (o = JSON.stringify(o)), x.set(e, o, r)
        },
                ...
                c = r => {
                    window.playAudioAlert = () => {
                        if (t) {
                            ...
                            n.buffer = r, n.connect(t.destination), n.loop = !1, n.start()
                        }
                    }
                };
            if (t) {
                const {
                    type: r = "dashboard",
                    alertTone: n = "ding"
                } = o || {}, u = `${e}/audio/${r}/${n}.mp3`, i = new Request(u);
                fetch(i).then(b => b.arrayBuffer()).then(b => (t.decodeAudioData(b).then(c), new Promise(s => s()))).catch(() => {})
            }
        },
        Ue = ({
            origin: e,
            ...
            return r.searchParams.append("cw_conversation", o), r.searchParams.append("website_token", t), r.searchParams.append("locale", c), r.toString()
        },
        De = (e, o, t, c) => {
            try {
                const r = Ue({
    ...
    function I(e, o) {
        if (o.length < e) throw new TypeError(e + " argument" + (e > 1 ? "s" : "") + " required, but only " + o.length + " present")
    }

    function Le(e) {
        I(1, arguments);
        var o = Object.prototype.toString.call(e);
        return e instanceof Date || typeof e == "object" && o === "[object Date]" ? new Date(e.getTime()) : typeof e == "number" || o === "[object Number]" ? new Date(e) : ((typeof e == "string" || o === "[object String]") && typeof console < "u" && (console.warn("Starting with v2.0.0-beta.1 date-fns doesn't accept strings as date arguments. Please use `parseISO` to parse strings. See: https://git.io/fjule"), console.warn(new Error().stack)), new Date(NaN))
    }
    ...
    const ee = (e, o = "") => O("cw_conversation", e, {
        ...
        g = {
            ...
            createFrame: ({
                ...
                c && (r = `${r}&cw_conversation=${c}`), t.src = r, t.allow = "camera;microphone;fullscreen;display-capture;picture-in-picture;clipboard-write;", t.id = "chatwoot_live_chat_widget", t.style.visibility = "hidden";
                let n = `woot-widget-holder woot--hide woot-elements--${window.$chatwoot.position}`;
                window.$chatwoot.hideMessageBubble && (n += " woot-widget--without-bubble"), z(window.$chatwoot.widgetStyle) && (n += " woot-widget-holder--flat"), y(v, n), v.id = "cw-widget-holder", v.dataset.turboPermanent = !0, v.appendChild(t), V.appendChild(v), g.initPostMessageCommunication(), g.initWindowSizeListener(), g.preventDefaultScroll()
            },
            getAppFrame: () => document.getElementById("chatwoot_live_chat_widget"),
            getBubbleHolder: () => document.getElementsByClassName("woot--bubble-holder"),
            sendMessage: (e, o) => {
                g.getAppFrame().contentWindow.postMessage(`chatwoot-widget:${JSON.stringify({event:e,...o})}`, "*")
            },
            ...
            events: {
                loaded: e => {
                    ee(e.config.authToken, window.$chatwoot.baseDomain), window.$chatwoot.hasLoaded = !0;
                    ...
                    }), g.toggleCloseButton(), window.$chatwoot.user && g.sendMessage("set-user", window.$chatwoot.user), window.playAudioAlert = () => {}, Z.forEach(t => {
                ...
                toggleBubble: e => {
                    let o = {};
                    e === "open" ? o.toggleValue = !0 : e === "close" && (o.toggleValue = !1), S(o)
                },
                popoutChatWindow: ({
                    baseUrl: e,
                    websiteToken: o,
                    ...
                    window.$chatwoot.toggle("close"), De(e, o, t, c)
                },
                closeWindow: () => {
                    S({
                        toggleValue: !1
            ...
            onLoad: ({
                ...
                if (o.style.visibility = "", o.setAttribute("id", "chatwoot_live_chat_widget"), g.getBubbleHolder().length) return;
                he(window.$chatwoot.hideMessageBubble), ie();
                let t = "woot-widget-bubble",
                    c = `woot-elements--${window.$chatwoot.position} woot-widget-bubble woot--close woot--hide`;
                z(window.$chatwoot.widgetStyle) && (t += " woot-widget-bubble--flat", c += " woot-widget-bubble--flat"), ve(e) && (t += " woot-widget-bubble-color--lighter", c += " woot-widget-bubble-color--lighter");
                const r = be({
                    className: t,
                    path: ue,
                    target: U
                });
                y($, c), r.style.background = e, $.style.background = e, C.appendChild(r), C.appendChild($), fe()
            },
            toggleCloseButton: () => {
                let e = !1;
                window.matchMedia("(max-width: 668px)").matches && (e = !0), g.sendMessage("toggle-close-button", {
                    isMobile: e
                })
            }
        },
        ...
        We = ({
            ...
            let c = t.locale,
                r = t.baseDomain;
            t.useBrowserLanguage && (c = window.navigator.language.replace("-", "_")), window.$chatwoot = {
                baseUrl: e,
                baseDomain: r,
                hasLoaded: !1,
                ...
                toggleBubbleVisibility(n) {
                    ...
                    n === "hide" ? (y(i, "woot-widget--without-bubble"), y(u, "woot-hidden"), window.$chatwoot.hideMessageBubble = !0) : n === "show" && (_(u, "woot-hidden"), _(i, "woot-widget--without-bubble"), window.$chatwoot.hideMessageBubble = !1), g.sendMessage(He, {
                        hideMessageBubble: window.$chatwoot.hideMessageBubble
                    })
                },
                popoutChatWindow() {
                ...
                setUser(n, u) {
                    if (typeof n != "string" && typeof n != "number") throw new Error("Identifier should be a string or a number");
                    if (!Fe(u)) throw new Error("User object should have one of the keys [avatar_url, email, name]");
                    const i = L(),
                        b = x.get(i),
                        s = Me({
                            identifier: n,
                    ...
                    s !== b && (window.$chatwoot.identifier = n, window.$chatwoot.user = u, g.sendMessage("set-user", {
                        identifier: n,
                        user: u
                    }), O(i, s, {
                        baseDomain: r
                ...
                setCustomAttributes(n = {}) {
                    if (!n || !Object.keys(n).length) throw new Error("Custom attributes should have atleast one key");
                    g.sendMessage("set-custom-attributes", {
                        customAttributes: n
                    })
                },
                deleteCustomAttribute(n = "") {
                    if (n) g.sendMessage("delete-custom-attribute", {
                        customAttribute: n
                    });
                    else throw new Error("Custom attribute is required")
                },
                ...
                deleteConversationCustomAttribute(n = "") {
                    if (n) g.sendMessage("delete-conversation-custom-attribute", {
                        customAttribute: n
                    });
                    else throw new Error("Custom attribute is required")
                },
                ...
                reset() {
                    window.$chatwoot.isOpen && g.events.toggleBubble(), x.remove("cw_conversation"), x.remove(L());
