...
})(Object.create(null)), C = e => (e = e.toLowerCase(), t => K(t) === e), v = e => t => typeof t === e, {
    isArray: D
} = Array, q = v("undefined");
...
const Ze = v("string"),
    ...
    it = C("URLSearchParams"),
    [at, ct, lt, ut] = ["ReadableStream", "Request", "Response", "Headers"].map(C),
    ft = e => e.trim ? e.trim() : e.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "");
...
const dt = (e, t, n, {
    ...
    wt = (e => t => e && t instanceof e)(typeof Uint8Array < "u" && ce(Uint8Array)),
    Et = (e, t) => {
    ...
    St = C("HTMLFormElement"),
    gt = e => e.toLowerCase().replace(/[-_\s]([a-z\d])(\w*)/g, function(n, r, s) {
...
const Pt = e => {
    ...
    Ft = C("AsyncFunction"),
    _t = e => e && (X(e) || x(e)) && x(e.then) && x(e.catch),
    _e = ((e, t) => e ? setImmediate : t ? ((n, r) => (U.addEventListener("message", ({
        source: s,
        data: o
    }) => {
    ...
    Ut = typeof queueMicrotask < "u" ? queueMicrotask.bind(U) : typeof process < "u" && process.nextTick || _e,
    a = {
        isArray: D,
        isArrayBuffer: xe,
        isBuffer: Ge,
    ...
    function u(p, y, h) {
        ...
        if (p && !h && typeof p == "object") {
            if (a.endsWith(y, "{}")) y = r ? y : y.slice(0, -2), p = JSON.stringify(p);
                ...
                !(a.isUndefined(g) || g === null) && t.append(i === !0 ? pe([y], P, o) : i === null ? y : y + "[]", l(g))
            }), !1
        }
    ...
    function R(p, y) {
        if (!a.isUndefined(p)) {
            ...
            d.push(p), a.forEach(p, function(w, S) {
                (!(a.isUndefined(w) || w === null) && s.call(t, w, a.isString(S) ? S.trim() : S, y, b)) === !0 && R(w, y ? y.concat(S) : [S])
            }), d.pop()
        }
    }
...
const je = {
    ...
    jt = typeof URLSearchParams < "u" ? URLSearchParams : le,
    ...
    Mt = ue && (!se || ["ReactNative", "NativeScript", "NS"].indexOf(se.product) < 0),
    zt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope && typeof self.importScripts == "function",
...
const Xt = a.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
    Gt = e => {
        const t = {};
        let n, r, s;
        return e && e.split(`
...
a.reduceDescriptors(A.prototype, ({
    value: e
}, t) => {
...
const V = (e, t, n = 3) => {
    ...
    we = e => (...t) => a.asap(() => e(...t)),
    sn = O.hasStandardBrowserEnv ? ((e, t) => n => (n = new URL(n, O.origin), e.protocol === n.protocol && e.host === n.host && (t || e.port === n.port)))(new URL(O.origin), O.navigator && /(msie|trident)/i.test(O.navigator.userAgent)) : () => !0,
...
const ze = e => {
    ...
    un = ln && function(e) {
        return new Promise(function(n, r) {
            ...
            function w() {
                if (!h) return;
                const g = A.from("getAllResponseHeaders" in h && h.getAllResponseHeaders()),
                    T = {
    ...
    $e = Q && typeof ReadableStream == "function",
    mn = Q && (typeof TextEncoder == "function" ? (e => t => e.encode(t))(new TextEncoder) : async e => new Uint8Array(await new Response(e).arrayBuffer())),
    Je = (e, ...t) => {
        try {
            return !!e(...t)
        } catch {
    ...
    Se = 64 * 1024,
    oe = $e && Je(() => a.isReadableStream(new Response("").body)),
    W = {
        stream: oe && (e => e.body)
    };
Q && (e => {
...
const bn = async e => {
        ...
        if (a.isSpecCompliantForm(e)) return (await new Request(O.origin, {
            method: "POST",
            body: e
    ...
    En = Q && (async e => {
        ...
        let R = fn([s, o && o.toAbortSignal()], i),
            p;
        ...
        try {
            ...
            throw y && y(), w && w.name === "TypeError" && /fetch/i.test(w.message) ? Object.assign(new m("Network Error", m.ERR_NETWORK, e, p), {
                cause: w.cause || w
...
function Oe(e) {
    return te(e), e.headers = A.from(e.headers), e.data = ee.call(e, e.transformRequest), ["post", "put", "patch"].indexOf(e.method) !== -1 && e.headers.setContentType("application/x-www-form-urlencoded", !1), Ve.getAdapter(e.adapter || I.adapter)(e).then(function(r) {
...
Z.transitional = function(t, n, r) {
    ...
    return (o, i, c) => {
        ...
        return n && !Te[i] && (Te[i] = !0, console.warn(s(i, " has been deprecated since v" + n + " and will be removed in the near future"))), t ? t(o, i, c) : !0
    }
};
