...
function f(a, e, t, i, l, c) {
    ...
    return v(), M(n, {
        ...
        "view-box": t.viewBox,
        "icon-lib": t.iconLib
    }, null, 8, ["size", "icon", "type", "icons", "view-box", "icon-lib"])
}
const V = Z(d, [
        ["render", f]
    ]),
    H = a => {
        "target" in a && a.setAttribute("target", "_blank")
    },
    y = {
        hooks: {
            afterSanitizeAttributes: H
        }
    },
    u = function() {
    ...
    s = function(a, e, t) {
        ...
        setTimeout(function() {
            ...
            if ((!a || !a.contains(n.target)) && l && c && typeof l == "function") return l.call(i, n)
        }, document.addEventListener(u(), a[o], !1)
    },
    r = function(a) {
        document.removeEventListener(u(), a[o], !1), delete a[o]
    },
    A = function(a, e, t) {
        e.value !== e.oldValue && s(a, e, t)
    },
    k = {
        mounted: s,
        updated: A,
